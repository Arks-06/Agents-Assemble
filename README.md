# Agents-Assemble
## Description
Agents-Assemble is a robust, multi-tenant backend architecture designed to orchestrate asynchronous AI research agents. It leverages **FastAPI** for a secure API layer, **PostgreSQL** for persistent state management, **Celery & Redis** for distributed background task queues, and **WebSockets** for real-time result broadcasting.
